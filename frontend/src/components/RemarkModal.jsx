...
const RemarkModal = ({ isOpen, onClose, solutionId, userId }) => {
  ...
  useEffect(() => {
    const fetchRemark = async () => {
      ...
      try {
        ...
        const response = await fetch(`${url}api/remark/`, {
          method: "GET",
        ...
        if (data?.remark) {
          setAdminRemarkInput(data.remark);
        }
      } catch (error) {
        console.log(error);
      }
  ...
  const handleRemark = async () => {
    ...
    try {
      let response = await fetch(`${url}api/remark`, {
        method: "POST",
        headers: {
  ...
  const handleUpdate = async () => {
    const response = await fetch(`${url}api/remark/update`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
      },
