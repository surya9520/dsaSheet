...
const Filters = ({
  ...
  const fetchlist = async () => {
    const response = await fetch(`${url}api/create/getlists`, {
      method: "GET",
      credentials: "include",
    });
    if (!response.ok) {
  ...
  //fetch datastructure
  const fetchds = async () => {
    const response = await fetch(`${url}api/add/getDatastructure`, {
      method: "GET",
      credentials: "include",
    });
    if (!response.ok) {
  ...
  const fetchComp = async () => {
    const response = await fetch(`${url}api/add/getCompany`, {
      method: "GET",
      credentials: "include",
    });
    if (!response.ok) {
  ...
  const fetchDiff = async () => {
    const response = await fetch(`${url}api/add/getComplexity`, {
      method: "GET",
      credentials: "include",
    });
    if (!response.ok) {
  ...
  const fetchPlt = async () => {
    const response = await fetch(`${url}api/add/getPlatform`, {
      method: "GET",
      credentials: "include",
    });
    if (!response.ok) {
